...
class _ChatDetailedState extends State<ChatDetailed> {
  ...
  Timestamp past = new Timestamp.fromDate(new DateTime(2021));
                    ...
                    if (snapshot.data.docs.length == 1)
                      return Column(
                        children: [
                          ...
                          FutureBuilder(
                                  future: _messageItem(message, context),
  ...
  Future<Widget> _messageItem(DocumentSnapshot message, BuildContext context) async {
